class Noodle < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "1fed92c472321ab5f1bcedb69f12ac470de5bb6538664bdc1af33c39ebcd10f8"
    end
  end
  ...
  on_linux do
    on_arm do
      ...
      sha256 "85a846e53afb9f26f541c9be2c190b06a5e44fb4991cd56d84fc7ed14090269b"
    end

    on_intel do
      url "https://github.com/wilfredinni/noodle/releases/download/v0.1.0/noodle-linux-x86_64"
      sha256 "de653b6668c3585ab77d115834cb1db32adeafe73d5b44ab39f993789442eeb2"
    end
  end
